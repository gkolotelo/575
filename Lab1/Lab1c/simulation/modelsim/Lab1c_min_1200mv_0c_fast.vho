...
ARCHITECTURE structure OF Exp1c IS
...
SIGNAL \mux3|m~1_combout\ : std_logic;
SIGNAL \SW[15]~input_o\ : std_logic;
SIGNAL \mux4|m~0_combout\ : std_logic;
...
-- Location: LCCOMB_X116_Y51_N0
\mux3|m~0\ : cycloneiv_lcell_comb
-- Equation(s):
-- \mux3|m~0_combout\ = (\SW[17]~input_o\ & ((\SW[1]~input_o\) # ((\SW[16]~input_o\)))) # (!\SW[17]~input_o\ & (((\SW[0]~input_o\ & !\SW[16]~input_o\))))
...
-- Location: LCCOMB_X116_Y51_N2
\mux3|m~1\ : cycloneiv_lcell_comb
-- Equation(s):
-- \mux3|m~1_combout\ = (\mux3|m~0_combout\ & ((\SW[3]~input_o\) # ((!\SW[16]~input_o\)))) # (!\mux3|m~0_combout\ & (((\SW[2]~input_o\ & \SW[16]~input_o\))))
...
\mux4|m~0\ : cycloneiv_lcell_comb
-- Equation(s):
-- \mux4|m~0_combout\ = (\SW[15]~input_o\ & (\SW[4]~input_o\)) # (!\SW[15]~input_o\ & ((\mux3|m~1_combout\)))
...
PORT MAP (
	dataa => \SW[4]~input_o\,
	datab => \mux3|m~1_combout\,
	datad => \SW[15]~input_o\,
	combout => \mux4|m~0_combout\);
